...
export const serverEnvironmentSchema = z.object({
    ...
    PENSJON_REGLER_VERIFISERING_URI: z.string().optional(),
    PENSJON_REGLER_VERIFISERING_SCOPE: z.string().optional(),
...
export const serverConfiguration: ServerConfiguration = {
    ...
    pensjonReglerVerifiseringURI: env.PENSJON_REGLER_VERIFISERING_URI,
    pensjonReglerVerifiseringScope: env.PENSJON_REGLER_VERIFISERING_SCOPE,
