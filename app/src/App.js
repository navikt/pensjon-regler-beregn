    ...
    return (
      <div class = "App"> 
        ...
        <div class = "menu-container" >
          ...
          <DropdownMenu href = {"MiljøTabeller"} name = "Aktiv Tabell i Miljø" list = {["Q1","Q2","Q3","Q4","Q5","T1","T2","T3","T4","PROD"]} onTabellChange = {this.handleMiljøChange} variant = {this.state.buttonVariant}>Aktiv Tabell i Miljø</DropdownMenu>
        </div>
